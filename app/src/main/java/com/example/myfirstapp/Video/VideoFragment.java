...
public class VideoFragment extends Fragment implements onVideoClickListener {
    ...
    public void openFullVideo(String videoUrl) {
        ...
        NavController navController = NavHostFragment.findNavController(VideoFragment.this);
        navController.navigate(R.id.action_videoFragment_to_fullVideoFragment,bundle);
    }
